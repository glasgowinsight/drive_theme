...
class AdWidget125_left extends WP_Widget {
	...
	function widget($args, $instance) {  
		...
		<ul class="ad125">
			<li><a href="<?php echo $href; ?>"><img class="" src="<?php echo $image; ?>" alt="" /></a></li>
			<li><a href="<?php echo $href2; ?>"><img class="" src="<?php echo $image2; ?>" alt="" /></a></li>
            
			<li><a href="<?php echo $href3; ?>"><img class="" src="<?php echo $image3; ?>" alt="" /></a></li>
			<li><a href="<?php echo $href4; ?>"><img class="" src="<?php echo $image4; ?>" alt="" /></a></li>
		</ul>
		<?php
