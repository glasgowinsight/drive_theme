				...
				init: function(d,e) {
						...
						d.addCommand( "OpenDialog",function(a,c){
							...
							// jQuery.get(e+"/dialog.php?tmnf-shortcodes-nonce=" + nonce,function(b){
								...
								tb_show( "Insert "+ SelectedShortcodeTitle +" Shortcode", "#TB_inline?width="+f+"&height="+b+"&inlineId=tmnf-dialog" );jQuery( "#tmnf-options h3:first").text( "Customize the "+c.title+" Shortcode" );
